...
const movieTemplate = (movieDetail) => {
  ...
  // Filters awards string for numbers and return sum
...
// let filteredStr = str.replace(/[^0-9]+/g, ' ').trim().replace(/\s/g, ',');
// let filteredStr = str.replace(/[^0-9]+/g, ' ').trim().split(' ');
